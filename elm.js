...
Elm.GameOfLife.make = function (_elm) {
   ...
   var evolve = function (universe) {
      return function () {
         ...
         var currentUniverse = dedupe($List.concat($List.map(cells)($List.map($Basics.fst)(universe))));
         return $List.filter(function ($) {
            return F2(function (x,y) {
               return _U.eq(x,y);
            })($Types.Alive)($Basics.snd($));
...
Elm.Main.make = function (_elm) {
   ...
   var blinker = create(_L.fromArray([{ctor: "_Tuple2"
                                      ,_0: 1
                                      ,_1: 1}
                                     ...
                                     ,{ctor: "_Tuple2"
                                      ,_0: 3
                                      ,_1: 1}]));
   var spaceShip = create(_L.fromArray([{ctor: "_Tuple2"
                                        ,_0: 2
                                        ,_1: 0}
                                       ...
                                       ,{ctor: "_Tuple2"
                                        ,_0: 2
                                        ,_1: 2}]));
   var pulsar = create(_L.fromArray([{ctor: "_Tuple2"
                                     ,_0: 4
                                     ,_1: 2}
...
Elm.Rules.make = function (_elm) {
   ...
   var numberOfLive = function (neighbours) {
      return $List.length($List.filter(F2(function (x,
      y) {
         return _U.eq(x,y);
      })($Types.Alive))(neighbours));
   };
   var underPopulationRule = F2(function (cell,
   neighbours) {
      return function () {
         switch (cell.ctor)
         {case "Alive":
   ...
   var livesOnRule = F2(function (cell,
   neighbours) {
      return function () {
         switch (cell.ctor)
         {case "Alive":
   ...
   var overPopulationRule = F2(function (cell,
   neighbours) {
      return function () {
         switch (cell.ctor)
         {case "Alive":
   ...
   var reproductionRule = F2(function (cell,
   neighbours) {
      return function () {
         switch (cell.ctor)
         {case "Alive":
   ...
   var applyRulesTest = _L.fromArray([{ctor: "_Tuple2"
                                      ,_0: _U.eq(A2(applyRules,
                                      $Types.Alive,
                                      _L.fromArray([$Types.Dead])),
                                      $Types.Dead)
                                      ,_1: "Underpopulation"}
                                     ,{ctor: "_Tuple2"
                                      ,_0: _U.eq(A2(applyRules,
                                      $Types.Alive,
                                      _L.fromArray([$Types.Alive
                                                   ,$Types.Alive
                                                   ,$Types.Dead])),
                                      $Types.Alive)
                                      ,_1: "Lives on with 2"}
...
Elm.View.make = function (_elm) {
   ...
   universe) {
      return function () {
         ...
         var rowsRange = _L.range(viewPort.yMin,
         viewPort.yMax);
         var rowsViewPort = A2($List.map,
         rowViewPort,
         rowsRange);
